...
function getManualChunk(id: string) {
  ...
  if (
    moduleId.includes('/src/pages/KLinePage') ||
  ...
  if (
    moduleId.includes('/src/pages/backtest/') ||
    moduleId.includes('/src/components/EquityChart')
  ) {
    return 'backtest-results';
  }
  if (moduleId.includes('/src/pages/BacktestPage')) return 'backtest-page';
  if (moduleId.includes('/src/pages/HomePage')) return 'home-page';
  ...
  if (
    moduleId.includes('/node_modules/antd/es/config-provider/') ||
  ...
  if (moduleId.includes('/node_modules/lightweight-charts/')) return 'chart-vendor';

...
class InfluxDBConfig:
    ...
    enabled: bool = os.getenv("INFLUXDB_ENABLED", "1").lower() not in ("0", "false", "no")


@dataclass
class PipelineConfig:
    input_dir: str = os.getenv("PIPELINE_INPUT_DIR", "data/input")
    output_dir: str = os.getenv("PIPELINE_OUTPUT_DIR", "data/output")
